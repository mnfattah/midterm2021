...
public class EmployeeInfo extends EmployeePii implements Employee {
    ...
    public static double calculateEmployeeBonus(double salary, String performance) {              //(int numberOfYearsWithCompany) {
        //int total = 0;
        //return total;
        double total = 0;
